...
function Basketball() {
    ...
    const addToCart = async (product) => {
        ...
        useEffect(() => {
            axios.get("http://localhost:5000/basketball").then((response) => {
                ...
                <div className="MainContent">
                    <div className="row">
                        {basketball.map((product) => (
                            <div className="col-md-4" key={product._id} style={{ marginTop: '1rem' }}>
                                <Card style={{ width: '19rem', border: 'none' }}>
                                    <Card.Img variant="top" src={product.image} />
                                    <Card.Body>
                                        <Card.Title className='shoename'>{product.name}</Card.Title>
                                        <Card.Text className='shoecategory'>{product.category}</Card.Text>
                                        <Card.Text className='shoeprice'>MRP: {product.price}</Card.Text>
                                        ...
                                        <Button
                                            ...
                                            className='btn2'
                                            style={{ marginTop: '0', display: 'inline', marginLeft: '5px' }}
                                        >
                                            Add to Bag
                                        </Button>
                                    </Card.Body>
